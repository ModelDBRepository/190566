'''
Current clamp demo using Allen Brain's model 473863578.
...
from neuron473863578 import Neuron473863578
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron473863578(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 473863578; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-91.0012588501)
        h.fcurrent()
